...
function docReady() {
    ...
    $('#calendar').fullCalendar({
        ...
        events: [
            {
                title: 'X',
				start: '2014-12-07T10:00:00',
                end: '2014-12-10T16:00:00',
				color: '#696868'
            },
			{
                title: 'X',
				start: '2014-12-11T18:00:00',
                end: '2014-12-11T20:00:00',
				color: '#696868'
            },
            {
                title: 'O',
				start: '2014-12-10T16:00:00',
                end: '2014-12-10T20:00:00',
				color: '#6f94ff',
				url: 'calendarform.html'
            },
			{
                title: 'O',
			...
			{
                title: 'O',
				start: '2014-12-11T20:00:00',
                end: '2014-12-13T20:00:00',
				color: '#6f94ff',
				url: 'calendarform.html'
            },
        ],
	...
	$('#calendarwithevent').fullCalendar({
        header: {
            left: 'prev,next',
            center: 'title',
            right: 'today'
